 ...
 * @author DELL
 */
public class UpdataDeletMember extends javax.swing.JFrame {

    /**
     * Creates new form UpdataDeletMember
     */
    public UpdataDeletMember() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Dalete Member");
        ...
        jLabel10.setText("Aadhar Number(Uniqe ID)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            RusultSet rs=st.executeQuery("Select *from member where id='"+id+"'");
            while(rs.next())
            {
                checkid=1;
                jTextField1.setEditable(false);
                jTextField2.getText(rs.getString(2));
                jTextField3.getText(rs.getString(3));
                jTextField4.getText(rs.getString(4));
                jTextField5.setEditable(false);
                jTextField5.getText(rs.getString(5));
                jTextField6.getText(rs.getString(6));
                jTextField7.getText(rs.getString(7));
                jTextField8.setEditable(false);
                jTextField8.getText(rs.getString(8));
                jTextField9.getText(rs.getString(9));
                jTextField10.getText(rs.getString(10));
                jTextField11.getText(rs.getString(11));
                
            }
            if(checkid==0)
            {
                JOptionPane.showMessageDialog(null,"Member dose not Exist");
            }
        }
            catch(Exception e)
            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Connection con=connectionprovider.getCon();
            PreparedStatement ps= con.prepareStatement("Update number set name=?,mobilenumber=?,email=?,fathername=?,mothername=?,aadharnumber=?,age=?,amount=? where id=?");
            ps.setString(1, name);
            ...
            setVisible(false);
            new UpdataDeletMember().setVisible(true);
        }    
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,e);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        int a=JOptionPane.showMessageDialog(null,"Do you really want to delete","Select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            String id=jTextField1.getText();
            try
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdataDeletMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
